...
#+begin_src emacs-lisp
  ...
  (setq org-agenda-custom-commands
        ...
        (setq org-agenda-custom-commands
              '(              ("r" "1SIE" search "-CANCELLED/"
                               ((org-agenda-overriding-header "SIE Reviews Scheduled")
                                (org-agenda-skip-function 'org-review-agenda-skip)
                                (org-agenda-cmp-user-defined 'org-review-compare)
                                (org-agenda-sorting-strategy '(user-defined-down))))

  ("m" "Review items with SIE_NEXT_REVIEW"
         agenda ""
         ((org-ql-block '(property "SIE_NEXT_REVIEW")
                        ((org-ql-block-header "Entries with SIE_NEXT_REVIEW property")
                         (org-ql-search-directories (org-agenda-files))))))))
...
#+begin_src elisp
  ...
  (setq org-jira-custom-jqls
        '(
          (:jql "issuetype != Epic AND Sprint in openSprints() AND statusCategory in (2, 4) AND assignee in (62eac8cc5111209f4fdeb0eb) ORDER BY cf[11975] ASC, cf[12020] "
...
#+begin_src elisp
  (use-package zetteldesk
    ...
    (add-to-list 'load-path "/Users/dmitry/.emacs.d/straight/repos/zetteldesk.el")
