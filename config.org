...
#+begin_src elisp
(straight-use-package '(dm-dueapp-integration :type git :local-repo "~/workspace/emacs-nursery" :no-build t :no-install t))
...
#+begin_src emacs-lisp
(use-package activity-watch-mode :straight t)
...
#+begin_src emacs-lisp
 ...
 (use-package doom-modeline :diminish :straight t
...
#+begin_src emacs-lisp
  (use-package org-superstar :straight t :hook (org-mode . (lambda () (org-superstar-mode 1))))
...
#+begin_src emacs-lisp
  ...
  (use-package dap-mode :straight t)
                                          ;(use-package dap-ui :straight t)
                                          ;(use-package dap-python :straight t :config (dap-mode 1) (dap-ui-mode 1))
#+end_src
...
#+begin_src emacs-lisp
(use-package expand-region :straight t :config
...
;    (use-package helm-lsp :straight t :commands helm-lsp-workspace-symbol)
  ...
  ;  (use-package dap-mode :straight t)
   ; (use-package dap-typescript :straight t)
...
#+begin_src elisp
  (use-package org-anki :straight t)
#+end_src
...
#+begin_src elisp
    (use-package org-pomodoro-third-time :straight t :init (org-pomodoro-third-time-mode +1)
...
** PlantUML
#+begin_src elisp
  ;;  (use-package plantuml-mode :straight t :init (setq plantuml-executable-path "/opt/homebrew/bin/plantuml" plantuml-default-exec-mode 'executable) :mode (("\\.plantuml\\'" . plantuml-mode)))

  (use-package plantuml-mode :straight t :init
...
#+begin_src elisp
;;  (use-package focus-autosave-mode :straight t :init (focus-autosave-mode))
...
#+begin_src elisp
  ...
  (use-package block-nav :straight t
...
(use-package org-review :straight t)
...
#+begin_src elisp
  ...
  ;;  (use-package pdf-tools-org-noter-helpers :straight t
  ;;   :straight (
...
#+begin_src elisp
  ...
  (use-package '(org-roam-review :type git :local-repo "~/workspace/emacs-nursery" :no-build t :no-install t)
