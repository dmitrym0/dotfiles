...
(set ediff-merge-revisions-with-ancestor t)
(setq ediff-show-clashes-only t)
(seta ediff-split-window-function 'split-window-horizontally)
(seta ediff-window-setup-function 'ediff-setup-windows-plain)
#+end_src
