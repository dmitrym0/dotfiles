...
#+begin_src emacs-lisp
  (message "Org-roam")
  (defun dm/goto-index (&optional key)
    (find-file (org-roam-node-file (org-roam-node-from-title-or-alias "index"))))
...
#+begin_src elisp
  ...
  (interactive)
    (setq org-agenda-files (flatten-tree
                            (append (dm/get-active-agenda-files) `(,(concat org-directory "gcal.org") ,(concat org-directory "vt-cal.org"))))))
